...
// functions that correspond to the C FFI types exposed by nvmagic-ffi. Each
...
extern char* nvmagic_scope_handle_uuid(const FfiScopeHandle* ptr);
extern char* nvmagic_scope_handle_name(const FfiScopeHandle* ptr);
extern int32_t nvmagic_scope_handle_scope_type(const FfiScopeHandle* ptr);
extern uint32_t nvmagic_scope_handle_attributes(const FfiScopeHandle* ptr);
extern char* nvmagic_scope_handle_parent_uuid(const FfiScopeHandle* ptr);
extern char* nvmagic_scope_handle_data(const FfiScopeHandle* ptr);
extern char* nvmagic_scope_handle_metadata(const FfiScopeHandle* ptr);
extern void nvmagic_scope_handle_free(FfiScopeHandle* ptr);

// Accessors — ToolHandle
extern char* nvmagic_tool_handle_uuid(const FfiToolHandle* ptr);
extern char* nvmagic_tool_handle_name(const FfiToolHandle* ptr);
extern uint32_t nvmagic_tool_handle_attributes(const FfiToolHandle* ptr);
extern char* nvmagic_tool_handle_parent_uuid(const FfiToolHandle* ptr);
extern void nvmagic_tool_handle_free(FfiToolHandle* ptr);

// Accessors — LLMHandle
extern char* nvmagic_llm_handle_uuid(const FfiLLMHandle* ptr);
extern char* nvmagic_llm_handle_name(const FfiLLMHandle* ptr);
extern uint32_t nvmagic_llm_handle_attributes(const FfiLLMHandle* ptr);
extern char* nvmagic_llm_handle_parent_uuid(const FfiLLMHandle* ptr);
extern void nvmagic_llm_handle_free(FfiLLMHandle* ptr);

// LLMRequest
extern FfiLLMRequest* nvmagic_llm_request_new(const char* headers_json, const char* content_json);
extern char* nvmagic_llm_request_headers(const FfiLLMRequest* ptr);
...
extern int32_t nvmagic_event_type(const FfiEvent* ptr);
extern char* nvmagic_event_data(const FfiEvent* ptr);
extern char* nvmagic_event_metadata(const FfiEvent* ptr);
extern char* nvmagic_event_timestamp(const FfiEvent* ptr);
extern char* nvmagic_event_input(const void* ptr);
extern char* nvmagic_event_output(const void* ptr);
extern char* nvmagic_event_model_name(const void* ptr);
extern char* nvmagic_event_tool_call_id(const void* ptr);
extern char* nvmagic_event_root_uuid(const void* ptr);
extern char* nvmagic_event_parent_uuid(const void* ptr);
extern char* nvmagic_event_scope_type(const void* ptr);
extern void nvmagic_event_free(FfiEvent* ptr);
...
func newScopeHandle(ptr *C.FfiScopeHandle) *ScopeHandle {
	...
	runtime.SetFinalizer(h, func(h *ScopeHandle) {
		if h.ptr != nil {
			C.nvmagic_scope_handle_free(h.ptr)
			h.ptr = nil
		}
	})
	return h
...
func newToolHandle(ptr *C.FfiToolHandle) *ToolHandle {
	...
	runtime.SetFinalizer(h, func(h *ToolHandle) {
		if h.ptr != nil {
			C.nvmagic_tool_handle_free(h.ptr)
			h.ptr = nil
		}
	})
	return h
...
func (h *ToolHandle) UUID() string { return goString(C.nvmagic_tool_handle_uuid(h.ptr)) }

// Name returns the name of the tool being called.
func (h *ToolHandle) Name() string { return goString(C.nvmagic_tool_handle_name(h.ptr)) }

// Attributes returns the attribute bitflags for this tool call.
func (h *ToolHandle) Attributes() uint32 {
	return uint32(C.nvmagic_tool_handle_attributes(h.ptr))
}

// ParentUUID returns the UUID of the parent scope for this tool call.
func (h *ToolHandle) ParentUUID() string {
	return goStringOpt(C.nvmagic_tool_handle_parent_uuid(h.ptr))
}
...
func newLLMHandle(ptr *C.FfiLLMHandle) *LLMHandle {
	...
	runtime.SetFinalizer(h, func(h *LLMHandle) {
		if h.ptr != nil {
			C.nvmagic_llm_handle_free(h.ptr)
			h.ptr = nil
		}
	})
	return h
...
func (h *LLMHandle) UUID() string { return goString(C.nvmagic_llm_handle_uuid(h.ptr)) }

// Name returns the name of the LLM being called.
func (h *LLMHandle) Name() string { return goString(C.nvmagic_llm_handle_name(h.ptr)) }

// Attributes returns the attribute bitflags for this LLM call.
func (h *LLMHandle) Attributes() uint32 {
	return uint32(C.nvmagic_llm_handle_attributes(h.ptr))
}

// ParentUUID returns the UUID of the parent scope for this LLM call.
func (h *LLMHandle) ParentUUID() string {
	return goStringOpt(C.nvmagic_llm_handle_parent_uuid(h.ptr))
}
...
func NewLLMRequest(headers map[string]interface{}, content interface{}) *LLMRequest {
	...
	ptr := C.nvmagic_llm_request_new(cHeaders, cContent)
	if ptr == nil {
		return nil
	}
	...
	runtime.SetFinalizer(r, func(r *LLMRequest) {
		if r.ptr != nil {
			C.nvmagic_llm_request_free(r.ptr)
			r.ptr = nil
		}
	})
	return r
...
func (r *LLMRequest) Headers() json.RawMessage {
	return goJSONOpt(C.nvmagic_llm_request_headers(r.ptr))
}
...
func (e *Event) ToolCallID() string {
	return goStringOpt((*C.char)(C.nvmagic_event_tool_call_id(unsafe.Pointer(e.ptr))))
}
...
func (e *Event) RootUUID() string {
	return goStringOpt((*C.char)(C.nvmagic_event_root_uuid(unsafe.Pointer(e.ptr))))
}
...
func (e *Event) ParentUUID() string {
	return goStringOpt((*C.char)(C.nvmagic_event_parent_uuid(unsafe.Pointer(e.ptr))))
}
...
func (e *Event) ScopeType() string {
	return goStringOpt((*C.char)(C.nvmagic_event_scope_type(unsafe.Pointer(e.ptr))))
}
