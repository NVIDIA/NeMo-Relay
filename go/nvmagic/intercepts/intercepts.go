...
// Package intercepts provides shorthand access to NVMagic intercept registration.
//
...
// drop the "Intercept" suffix found in the parent nvmagic package.
//
...
// Example usage:
//
//	import "github.com/nvidia/nvmagic/go/nvmagic/intercepts"
//
...
// this one. This is a shorthand for [nvmagic.RegisterToolRequestIntercept].
func RegisterToolRequest(name string, priority int32, breakChain bool, fn nvmagic.ToolSanitizeFunc) error {
	return nvmagic.RegisterToolRequestIntercept(name, priority, breakChain, fn)
}

// DeregisterToolRequest removes a tool request intercept by name. This is a
// shorthand for [nvmagic.DeregisterToolRequestIntercept].
func DeregisterToolRequest(name string) error {
	return nvmagic.DeregisterToolRequestIntercept(name)
}
...
// one. This is a shorthand for [nvmagic.RegisterToolResponseIntercept].
func RegisterToolResponse(name string, priority int32, breakChain bool, fn nvmagic.ToolSanitizeFunc) error {
	return nvmagic.RegisterToolResponseIntercept(name, priority, breakChain, fn)
}

// DeregisterToolResponse removes a tool response intercept by name. This is a
// shorthand for [nvmagic.DeregisterToolResponseIntercept].
func DeregisterToolResponse(name string) error {
	return nvmagic.DeregisterToolResponseIntercept(name)
}
...
// shorthand for [nvmagic.DeregisterToolExecutionIntercept].
func DeregisterToolExecution(name string) error {
	return nvmagic.DeregisterToolExecutionIntercept(name)
}
...
// shorthand for [nvmagic.DeregisterLlmRequestIntercept].
...
// shorthand for [nvmagic.DeregisterLlmExecutionIntercept].
func DeregisterLlmExecution(name string) error {
	return nvmagic.DeregisterLlmExecutionIntercept(name)
}
...
// name. This is a shorthand for [nvmagic.DeregisterLlmStreamExecutionIntercept].
func DeregisterLlmStreamExecution(name string) error {
	return nvmagic.DeregisterLlmStreamExecutionIntercept(name)
}
