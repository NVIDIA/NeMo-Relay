...
extern int32_t nemo_flow_push_scope(const char* name, int32_t scope_type, const FfiScopeHandle* parent, uint32_t attributes, const char* data_json, const char* metadata_json, FfiScopeHandle** out);
extern int32_t nemo_flow_pop_scope(const FfiScopeHandle* handle);
extern int32_t nemo_flow_event(const char* name, const FfiScopeHandle* parent, const char* data_json, const char* metadata_json);

// Tool lifecycle
extern int32_t nemo_flow_tool_call(const char* name, const char* args_json, const FfiScopeHandle* parent, uint32_t attributes, const char* data_json, const char* metadata_json, const char* tool_call_id, FfiToolHandle** out);
extern int32_t nemo_flow_tool_call_end(const FfiToolHandle* handle, const char* result_json, const char* data_json, const char* metadata_json);
...
extern int32_t nemo_flow_llm_call(const char* name, const char* native_json, const FfiScopeHandle* parent, uint32_t attributes, const char* data_json, const char* metadata_json, const char* model_name, FfiLLMHandle** out);
extern int32_t nemo_flow_llm_call_end(const FfiLLMHandle* handle, const char* response_json, const char* data_json, const char* metadata_json);
...
func PushScope(name string, scopeType ScopeType, opts ...ScopeOption) (*ScopeHandle, error) {
	...
	var out *C.FfiScopeHandle
	status := C.nemo_flow_push_scope(cName, C.int32_t(scopeType), o.parent, C.uint32_t(o.attributes), o.data, o.metadata, &out)
	if err := checkStatus(status); err != nil {
		return nil, err
	}
	return newScopeHandle(out), nil
...
func PopScope(handle *ScopeHandle) error {
	return checkStatus(C.nemo_flow_pop_scope(handle.ptr))
}
...
func EmitEvent(name string, opts ...EventOption) error {
	...
	return checkStatus(C.nemo_flow_event(cName, o.parent, o.data, o.metadata))
}
...
func ToolCall(name string, args json.RawMessage, opts ...ToolCallOption) (*ToolHandle, error) {
	...
	status := C.nemo_flow_tool_call(cName, cArgs, o.parent, C.uint32_t(o.attributes), o.data, o.metadata, o.toolCallID, &out)
	if err := checkStatus(status); err != nil {
		return nil, err
	}
...
func ToolCallEnd(handle *ToolHandle, result json.RawMessage, opts ...ToolCallOption) error {
	...
	return checkStatus(C.nemo_flow_tool_call_end(handle.ptr, cResult, o.data, o.metadata))
}
...
func LlmCall(name string, request interface{}, opts ...LLMCallOption) (*LLMHandle, error) {
	...
	status := C.nemo_flow_llm_call(cName, cRequest, o.parent, C.uint32_t(o.attributes), o.data, o.metadata, o.modelName, &out)
	if err := checkStatus(status); err != nil {
		return nil, err
	}
...
func LlmCallEnd(handle *LLMHandle, response json.RawMessage, opts ...LLMCallOption) error {
	...
	return checkStatus(C.nemo_flow_llm_call_end(handle.ptr, cResponse, o.data, o.metadata))
}
