...
extern int32_t nemo_flow_validate_optimizer_config(const char* config_json, char** out_json);
extern int32_t nemo_flow_optimizer_runtime_create(const char* config_json, FfiOptimizerRuntime** out);
extern int32_t nemo_flow_optimizer_runtime_register(FfiOptimizerRuntime* runtime);
extern int32_t nemo_flow_optimizer_runtime_deregister(FfiOptimizerRuntime* runtime);
extern int32_t nemo_flow_optimizer_runtime_shutdown(FfiOptimizerRuntime* runtime);
extern int32_t nemo_flow_optimizer_runtime_report_json(const FfiOptimizerRuntime* runtime, char** out_json);
extern void nemo_flow_optimizer_runtime_free(FfiOptimizerRuntime* ptr);
extern void nemo_flow_string_free(char* ptr);

typedef void (*NemoFlowFreeFn)(void* user_data);
typedef char* (*NemoFlowOptimizerPluginValidateCb)(void* user_data, const char* instance_id, const char* plugin_config_json);
typedef int32_t (*NemoFlowOptimizerPluginRegisterCb)(void* user_data, const char* instance_id, const char* plugin_config_json, FfiOptimizerPluginContext* ctx);
...
extern int32_t nemo_flow_optimizer_register_plugin(const char* plugin_kind, NemoFlowOptimizerPluginValidateCb validate_cb, NemoFlowOptimizerPluginRegisterCb register_cb, void* user_data, NemoFlowFreeFn free_fn);
extern int32_t nemo_flow_optimizer_deregister_plugin(const char* plugin_kind);
extern int32_t nemo_flow_optimizer_plugin_context_register_subscriber(FfiOptimizerPluginContext* ctx, const char* name, NemoFlowEventSubscriberFn cb, void* user_data, NemoFlowFreeFn free_fn);
extern int32_t nemo_flow_optimizer_plugin_context_register_llm_request_intercept(FfiOptimizerPluginContext* ctx, const char* name, int32_t priority, _Bool break_chain, NemoFlowLlmRequestInterceptCb cb, void* user_data, NemoFlowFreeFn free_fn);
extern int32_t nemo_flow_optimizer_plugin_context_register_tool_request_intercept(FfiOptimizerPluginContext* ctx, const char* name, int32_t priority, _Bool break_chain, NemoFlowToolSanitizeFn cb, void* user_data, NemoFlowFreeFn free_fn);
extern int32_t nemo_flow_optimizer_plugin_context_register_llm_execution_intercept(FfiOptimizerPluginContext* ctx, const char* name, int32_t priority, NemoFlowLlmExecInterceptCb cb, void* user_data, NemoFlowFreeFn free_fn);
extern int32_t nemo_flow_optimizer_plugin_context_register_llm_stream_execution_intercept(FfiOptimizerPluginContext* ctx, const char* name, int32_t priority, NemoFlowLlmExecInterceptCb cb, void* user_data, NemoFlowFreeFn free_fn);
extern int32_t nemo_flow_optimizer_plugin_context_register_tool_execution_intercept(FfiOptimizerPluginContext* ctx, const char* name, int32_t priority, NemoFlowToolExecInterceptCb cb, void* user_data, NemoFlowFreeFn free_fn);
...
func ValidateOptimizerConfig(config OptimizerConfig) (OptimizerConfigReport, error) {
	...
	var out *C.char
	status := C.nemo_flow_validate_optimizer_config(cConfig, &out)
...
func NewOptimizerRuntime(config OptimizerConfig) (*OptimizerRuntime, error) {
	...
	status := C.nemo_flow_optimizer_runtime_create(cConfig, &ptr)
	if err := checkStatus(status); err != nil {
		return nil, err
	}
...
func (r *OptimizerRuntime) Register() error {
	...
	return checkStatus(C.nemo_flow_optimizer_runtime_register(r.ptr))
}
...
func (r *OptimizerRuntime) Deregister() error {
	...
	return checkStatus(C.nemo_flow_optimizer_runtime_deregister(r.ptr))
}
...
func (r *OptimizerRuntime) Shutdown() error {
	...
	ptr := r.ptr
	r.ptr = nil
	return checkStatus(C.nemo_flow_optimizer_runtime_shutdown(ptr))
}
...
func (r *OptimizerRuntime) Report() (OptimizerConfigReport, error) {
	...
	var out *C.char
	status := C.nemo_flow_optimizer_runtime_report_json(r.ptr, &out)
	if err := checkStatus(status); err != nil {
		return OptimizerConfigReport{}, err
	}
	defer C.nemo_flow_string_free(out)
...
func (r *OptimizerRuntime) Close() {
	...
	C.nemo_flow_optimizer_runtime_free(r.ptr)
	r.ptr = nil
}
...
func RegisterOptimizerPlugin(pluginKind string, handler OptimizerPluginHandler) error {
	...
	status := C.nemo_flow_optimizer_register_plugin(
		cPluginKind,
		(C.NemoFlowOptimizerPluginValidateCb)(C.goOptimizerPluginValidateTrampoline),
		(C.NemoFlowOptimizerPluginRegisterCb)(C.goOptimizerPluginRegisterTrampoline),
		userData,
...
func DeregisterOptimizerPlugin(pluginKind string) error {
	cPluginKind := C.CString(pluginKind)
	defer C.free(unsafe.Pointer(cPluginKind))
	return checkStatus(C.nemo_flow_optimizer_deregister_plugin(cPluginKind))
}
...
func (ctx *OptimizerPluginContext) RegisterSubscriber(name string, fn EventSubscriberFunc) error {
	...
	return checkStatus(C.nemo_flow_optimizer_plugin_context_register_subscriber(
		ctx.ptr,
		cName,
...
func (ctx *OptimizerPluginContext) RegisterLlmRequestIntercept(name string, priority int32, breakChain bool, fn LLMRequestInterceptFunc) error {
	...
	defer C.free(unsafe.Pointer(cName))
	userData := registerClosure(fn)
	return checkStatus(C.nemo_flow_optimizer_plugin_context_register_llm_request_intercept(
		ctx.ptr,
		cName,
		C.int32_t(priority),
		C._Bool(breakChain),
...
func (ctx *OptimizerPluginContext) RegisterToolRequestIntercept(name string, priority int32, breakChain bool, fn ToolSanitizeFunc) error {
	...
	defer C.free(unsafe.Pointer(cName))
	userData := registerClosure(fn)
	return checkStatus(C.nemo_flow_optimizer_plugin_context_register_tool_request_intercept(
		ctx.ptr,
		cName,
		C.int32_t(priority),
		C._Bool(breakChain),
...
func (ctx *OptimizerPluginContext) RegisterLlmExecutionIntercept(name string, priority int32, fn LLMExecutionInterceptFunc) error {
	...
	defer C.free(unsafe.Pointer(cName))
	userData := registerClosure(fn)
	return checkStatus(C.nemo_flow_optimizer_plugin_context_register_llm_execution_intercept(
		ctx.ptr,
		cName,
		C.int32_t(priority),
...
func (ctx *OptimizerPluginContext) RegisterLlmStreamExecutionIntercept(name string, priority int32, fn LLMExecutionInterceptFunc) error {
	...
	defer C.free(unsafe.Pointer(cName))
	userData := registerClosure(fn)
	return checkStatus(C.nemo_flow_optimizer_plugin_context_register_llm_stream_execution_intercept(
		ctx.ptr,
		cName,
		C.int32_t(priority),
		(C.NemoFlowLlmExecInterceptCb)(C.goLlmExecInterceptTrampoline),
...
func (ctx *OptimizerPluginContext) RegisterToolExecutionIntercept(name string, priority int32, fn ToolExecutionInterceptFunc) error {
	...
	defer C.free(unsafe.Pointer(cName))
	userData := registerClosure(fn)
	return checkStatus(C.nemo_flow_optimizer_plugin_context_register_tool_execution_intercept(
		ctx.ptr,
		cName,
		C.int32_t(priority),
