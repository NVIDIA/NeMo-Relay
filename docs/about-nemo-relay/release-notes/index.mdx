...
local NeMo Guardrails execution, LLM response annotations with model pricing,
...
- Model pricing estimates require configured model pricing sources. NeMo Relay
  does not ship provider price data by default.
