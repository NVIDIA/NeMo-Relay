...
- Model pricing estimates depend on configured model pricing sources and the
  freshness of the source catalog. Unknown model pricing and missing token data
  leave cost absent instead of defaulting to zero.
