...
The active scope stack defines the current ownership context for runtime work.
It establishes:
...
managed call does not advance past that middleware checkpoint until the callback
returns.
