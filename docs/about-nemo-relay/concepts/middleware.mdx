...
Python helpers cannot drive an awaitable callback and raise an error directing
the caller to the corresponding asynchronous helper. Relay awaits entries
