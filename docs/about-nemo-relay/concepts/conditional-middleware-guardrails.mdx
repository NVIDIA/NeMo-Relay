...
open on callback, transport, or timeout errors. Native plugins install a host-resident
constant reason so snapshot construction never enters the dynamic library.
