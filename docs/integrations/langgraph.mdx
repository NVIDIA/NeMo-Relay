---
title: "NeMo Flow LangGraph Integration"
...
```bash title="uv" for="uv"
uv add "nemo-flow[langgraph]"
```

```bash title="pip" for="pip"
...
Refer to [Observability](/observability-plugin/about) for details on exporting NeMo Flow observability data to third-party systems.
