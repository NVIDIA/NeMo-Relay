...
Use the [What Should I Read First?](/about-nemo-flow/overview#what-should-i-read-first)
...
for scope-local middleware and subscribers. Refer to [Scopes](/about-nemo-flow/concepts/scopes)
...
Refer to [Scopes](/about-nemo-flow/concepts/scopes#context-isolation) and the
...
Refer to [Events](/about-nemo-flow/concepts/events) and
...
Refer to [Middleware](/about-nemo-flow/concepts/middleware) and
...
configuration. Refer to [Registration Levels](/about-nemo-flow/concepts/middleware#registration-levels)
...
chain. Refer to [Managed Execution Order](/about-nemo-flow/concepts/middleware#managed-execution-order).
...
Refer to [Middleware](/about-nemo-flow/concepts/middleware#guardrails) and
...
Refer to [Subscribers](/about-nemo-flow/concepts/subscribers),
[Events](/about-nemo-flow/concepts/events), and
[Observability](/observability-plugin/about).

### Which Exporter Should I Use?

Use a local subscriber for debugging and dev. Use OpenTelemetry when you
...
scopes, middleware, or subscribers. Refer to [Plugins](/about-nemo-flow/concepts/plugins)
...
Refer to [Framework Integrations](/about-nemo-flow/concepts/framework-integrations) and
...
Use [Release Notes](/about-nemo-flow/release-notes) for
...
- Documentation changes: run `./scripts/build-docs.sh check`.
