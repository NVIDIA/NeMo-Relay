...
| Managed LLM `input` | Supported | Extension point only today |
| Managed LLM `output` | Supported | Extension point only today |
| Managed `tool_input` | Supported | Extension point only today |
| Managed `tool_output` | Supported | Extension point only today |
