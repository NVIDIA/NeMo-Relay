...
- **Coding-Agent CLI Users**: Start with [CLI Gateway Quick Start](getting-started/cli.md), then use the per-agent gateway guide for Claude Code, Codex, Cursor, or Hermes.
