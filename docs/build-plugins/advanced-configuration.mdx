---
title: "Design Plugin Configuration"
description: ""
position: 6
---
...
- Build the first plugin with [Define a Plugin](/build-plugins/basic-guide).
- Validate plugin config with [Validate Plugin Configuration](/build-plugins/validate-configuration).
- Register runtime behavior with [Register Plugin Behavior](/build-plugins/register-behavior).
- Review reusable patterns in [Code Examples](/build-plugins/code-examples).
