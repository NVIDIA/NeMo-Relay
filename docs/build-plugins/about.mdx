...
- [NeMo Guardrails Example Plugin](/build-plugins/nemoguardrails) shows an external Python plugin that applies NeMo Guardrails checks around NeMo Flow LLM and tool calls.
