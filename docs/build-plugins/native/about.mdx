...
| C host-table ABI | v6 | Function table negotiated by the current `nemo-relay-plugin` SDK. The host also exposes frozen v5, v4, v3, and v2 tables for compatible older binaries. |
