...
| C host-table ABI | v7 | Function table required by the current `nemo-relay-plugin` SDK. Relay 0.10 rejects v2-v6 callback layouts. |
...
Relay 0.10 adds ABI v7 with directional codec context on every LLM
