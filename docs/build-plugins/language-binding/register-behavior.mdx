...
2. Initialize the valid document with `initialize`,
   `plugin.initialize`, or `plugin.initialize`. Keep the returned
   activation handle alive for the entire host lifetime.
