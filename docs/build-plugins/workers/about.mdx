...
use a directory of your choice; Relay creates it when it does not exist. This applies to
Python, Rust, and custom-command workers; it is particularly useful when the system
temporary directory is too long or a deployment requires snapshots on controlled storage.
