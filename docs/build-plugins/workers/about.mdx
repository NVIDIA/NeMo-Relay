...
outside every active plugin package directory. This applies to Python, Rust, and custom-command
workers; it is particularly useful when the system temporary directory is too long or a
deployment requires snapshots on controlled storage.
