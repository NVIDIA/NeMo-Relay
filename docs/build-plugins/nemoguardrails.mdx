...
[`agent_example.py`](https://github.com/NVIDIA/NeMo-Flow/blob/main/examples/nemoguardrails/example/agent_example.py), a
...
[`example_config.yml`](https://github.com/NVIDIA/NeMo-Flow/blob/main/examples/nemoguardrails/example/example_config.yml)
