...
- Define validation behavior with [Validate Plugin Configuration](/build-plugins/validate-configuration).
- Register runtime behavior with [Register Plugin Behavior](/build-plugins/register-behavior).
- Add rollout controls with [Design Plugin Configuration](/build-plugins/advanced-configuration).
- Review complete examples in [Code Examples](/build-plugins/code-examples).
