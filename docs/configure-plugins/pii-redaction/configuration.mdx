...
policy safely applies to OpenAI Chat, OpenAI Responses, Anthropic Messages, and Gemini
traffic:
...
| Codec support | `openai_chat`, `openai_responses`, `anthropic_messages`, `gemini` | Runtime-specific future implementation |
