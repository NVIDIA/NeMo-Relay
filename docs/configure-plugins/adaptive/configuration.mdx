...
Close the activation during shutdown or test cleanup. Closing the activation
deregisters the adaptive subscribers and intercepts owned by the plugin runtime.
