...
- [Response Cache](/configure-plugins/adaptive/response-cache) explains the opt-in LLM response and
  classified tool-result cache: turning it on, what gets cached, and how savings are reported.
