...
loading plugin code or acquiring the activation lease. Use Rust `validate_exact()`
when only the supplied static configuration should be checked. For complete
