...
| Field | Default | Notes |
|---|---|---|
| `name` | None | Optional unique name that another component can use to reference this endpoint. Names must be non-empty and cannot have leading or trailing whitespace. |
