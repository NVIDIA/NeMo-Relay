...
| `header_file` | `{}` | Header names mapped to files read for every completed-trajectory upload. Files must exist at activation; trailing whitespace is removed from each value. |
