...
that follow the OpenTelemetry GenAI message schemas. These attributes can
contain sensitive prompt and response content; use event sanitizers to redact
content before export. Tool payloads and retrieval content are not exported.
