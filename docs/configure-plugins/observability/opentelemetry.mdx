...
reserved schema by hand: `metric` in Rust, Python, and Node.js, or `EmitMetric`
in Go. The helper validates the complete measurement group before publishing the
