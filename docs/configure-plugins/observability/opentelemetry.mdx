...
| `OTEL_BSP_SCHEDULE_DELAY` | Automatic | SDK span batch delay; does not activate export. |
| `OTEL_BSP_EXPORT_TIMEOUT` | Automatic | SDK span batch export timeout; does not activate export. |
| `OTEL_BSP_MAX_QUEUE_SIZE` | Automatic | SDK span batch queue limit; does not activate export. |
| `OTEL_BSP_MAX_EXPORT_BATCH_SIZE` | Automatic | SDK span batch size; does not activate export. |
