...
Arguments and results must be JSON objects under the OpenTelemetry schemas.
Relay parses serialized JSON objects before projecting them as JSON strings;
plain text, arrays, scalars, null, and missing values are omitted. Failed tool
