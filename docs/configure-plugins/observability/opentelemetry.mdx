...
Projection behavior is fixed. The configuration does not expose
`mark_projection`, `mark_exclude_names`, `attribute_mappings`,
`semantic_selector`, or `capture_content`.
