...
[components.config.opentelemetry.endpoints.activation_policy]
...
| `activation_policy` | Omitted | Optional activation hook for this endpoint. Relay evaluates derived trace, log, and metric targets separately and does not construct denied exporters. |
