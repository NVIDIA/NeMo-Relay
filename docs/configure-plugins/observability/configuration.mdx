...
unsupported transports, unsupported ATOF modes, invalid ATOF stream sink URLs,
non-string stream sink headers, non-positive stream sink timeouts, unsafe ATIF
