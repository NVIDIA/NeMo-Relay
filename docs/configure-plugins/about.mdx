...
- [Switchyard Migration](/configure-plugins/switchyard/about) explains the
  removal of Relay's built-in service integration and points to the
  Switchyard-owned dynamic plugin planned for Switchyard 0.3.0.
