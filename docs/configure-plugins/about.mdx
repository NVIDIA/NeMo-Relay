...
| Load enabled discoverable plugins from Python | Use the owned initializer in [Configure Discoverable Plugins](/configure-plugins/discoverable-plugins#initialize-discoverable-plugins-from-python). |
