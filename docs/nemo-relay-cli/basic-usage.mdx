...
the fixed gateway and private install-generation fence explicitly, preflights
its Relay identity, and joins the shared endpoint recovery cohort before
forwarding the unchanged payload. Hermes
