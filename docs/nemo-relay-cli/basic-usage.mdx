...
the fixed gateway explicitly, preflights its Relay identity, and performs one
coordinated start or recovery before forwarding the unchanged payload. Hermes
