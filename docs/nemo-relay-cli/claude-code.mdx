...
gateway becomes unhealthy. Claude Code and Codex MCP clients share a compatible
gateway, and the gateway exits after the final client's idle timeout. The MCP
