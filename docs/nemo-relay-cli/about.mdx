...
| Cursor | ✅ Yes | ⚠️ Partial | ⚠️ Partial | Hook forwarding and gateway-routed LLM optimization are supported. Missing hooks under `cursor-agent` limit full feature coverage. |
