...
- [Adding Scopes](/integrate-into-frameworks/adding-scopes) shows how framework request and run hooks become NeMo Flow ownership boundaries.
...
[NeMo Flow CLI](/nemo-flow-cli/about). That section covers Claude Code,
