...
Use this page to plan upgrades to the current NeMo Relay release. It groups the
actions from the release notes by the surface you operate. The [Release Notes
and Known Issues](/about-nemo-relay/release-notes/known-issues#compatibility-and-migration-notes)
remain the complete, release-specific source for compatibility details.
...
For exact changed schemas, public API names, examples, and implementation PRs,
use the [0.6 compatibility and migration
notes](/about-nemo-relay/release-notes/known-issues#compatibility-and-migration-notes).
Use [GitHub Releases](https://github.com/NVIDIA/NeMo-Relay/releases) for the
complete release history and notes for a specific tag.
