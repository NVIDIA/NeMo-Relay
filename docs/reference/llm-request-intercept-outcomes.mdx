...
- Rust and Python `grpc-v2` worker SDKs return their canonical outcome in a
...
This section describes the NeMo Relay 0.6 migration and its then-current
`grpc-v1` worker protocol. Current workers use `grpc-v2`.
