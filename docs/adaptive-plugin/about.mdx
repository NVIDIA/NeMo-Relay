...
- Topology-aware convergence, drift, and hint load-shedding controls.
...
- Stop adaptive learning once observed topology-aware signals stabilize.
...
- [Topology-Aware Controls Design](/adaptive-plugin/topology-aware-controls-design)
  documents the internal design, measurable outcomes, and observable signals for
  convergence, drift, and hint-governor controls.
