...
Use this path when you want the published package for application dev.
...
This path is for local source dev when you need to build the binding from the repository checkout.
