...
| `just` | see [Development Setup](/contribute/development-setup) | Repository dev, test, build, and docs task aliases |
...
Install dev dependencies for Python and docs workflows:
