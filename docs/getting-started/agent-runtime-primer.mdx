...
or outcome that matches your task; the linked guide gives the exact install,
...
- **Local Claude Code, Codex, Cursor, or Hermes runs:** The coding-agent harness
...
- **Reusable runtime behavior across services or teams:** Runtime plugin
  configuration owns reusable middleware, subscribers, exporters, pricing,
