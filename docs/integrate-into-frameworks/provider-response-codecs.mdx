...
catalog `version: 1`). Future NeMo Relay releases may add new optional fields to
...
The following behaviors are intentional in this release but may change later:
