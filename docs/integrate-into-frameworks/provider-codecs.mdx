...
- `TypeSafeSystemOneCodec`: TypeSafe System One evaluation requests and
  responses. This codec exposes typed evaluation data through `api_specific`
  and intentionally does not synthesize chat messages or generated text.
