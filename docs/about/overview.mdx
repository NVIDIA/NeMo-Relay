...
| Understand the runtime model | [Concepts](/about-nemo-flow/concepts) |
...
| Observe a local coding-agent CLI | [NeMo Flow CLI](/nemo-flow-cli/about) |
...
| Configure adaptive behavior | [Adaptive](/adaptive-plugin/about) |
