...
- [LlmCodecIdentity](/reference/api/rust-library-reference/nemo-relay/api/runtime/callbacks/enum-llmcodecidentity): Per-call LLM codec identity supplied to sanitize guardrails.
