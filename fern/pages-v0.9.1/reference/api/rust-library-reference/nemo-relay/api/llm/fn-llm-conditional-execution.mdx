...
<pre className="rust-signature"><code dangerouslySetInnerHTML={{"__html": "pub async fn llm_conditional_execution(request: &amp;<a href=\"struct-llmrequest\">LlmRequest</a>) -&gt; <a href=\"../../error/type-result\">Result</a>&lt;<a href=\"https://doc.rust-lang.org/1.96.1/std/primitive.unit.html\">()</a>&gt;"}} /></pre>
