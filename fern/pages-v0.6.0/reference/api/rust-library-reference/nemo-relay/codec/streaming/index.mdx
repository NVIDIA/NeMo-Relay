...
- [NormalizedStreamEvent](/reference/api/rust-library-reference/nemo-relay/codec/streaming/enum-normalizedstreamevent): Provider-neutral incremental stream item used by cross-protocol transcoders.
