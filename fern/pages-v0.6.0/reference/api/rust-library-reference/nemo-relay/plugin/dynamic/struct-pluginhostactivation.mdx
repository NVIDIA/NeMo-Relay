...
<pre className="rust-signature"><code dangerouslySetInnerHTML={{"__html": "pub fn clear(self) -&gt; <a href=\"../type-result\">Result</a>&lt;<a href=\"https://doc.rust-lang.org/1.96.1/std/primitive.unit.html\">()</a>&gt;"}} /></pre>
