...
- [LlmRequestInterceptOutcome](/reference/api/rust-library-reference/nemo-relay/api/llm/struct-llmrequestinterceptoutcome): Result of an LLM request intercept that can schedule lifecycle marks.
...
- [LLM_REQUEST_INTERCEPT_OUTCOME_SCHEMA](/reference/api/rust-library-reference/nemo-relay/api/llm/constant-llm-request-intercept-outcome-schema): Versioned JSON envelope schema for [`LlmRequestInterceptOutcome`](/reference/api/rust-library-reference/nemo-relay/api/llm/struct-llmrequestinterceptoutcome).
