...
[`agent_example.py`](https://github.com/NVIDIA/NeMo-Relay/blob/0.3.0-rc.1/examples/nemoguardrails/example/agent_example.py), a
...
[`example_config.yml`](https://github.com/NVIDIA/NeMo-Relay/blob/0.3.0-rc.1/examples/nemoguardrails/example/example_config.yml)
