...
- [optimization](/reference/api/rust-library-reference/nemo-relay/api/optimization): Plugin-neutral evidence recording for managed LLM calls. Managed, bounded LLM optimization accounting.
