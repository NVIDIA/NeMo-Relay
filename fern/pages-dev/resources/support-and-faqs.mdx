...
- Use [Python Quick Start](/getting-started/python) when you are adding
  NeMo Relay to Python application code or agent harnesses.
- Use [Node.js Quick Start](/getting-started/nodejs) when your application,
  framework integration, or plugin-facing code runs in Node.js.
- Use [Rust Quick Start](/getting-started/rust) when you want the native
