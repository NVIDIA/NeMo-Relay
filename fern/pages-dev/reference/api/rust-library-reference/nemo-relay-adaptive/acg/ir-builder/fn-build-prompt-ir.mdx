...
<pre className="rust-signature"><code dangerouslySetInnerHTML={{"__html": "pub fn build_prompt_ir(request: &amp;<a href=\"../../../nemo-relay/codec/request/struct-annotatedllmrequest\">AnnotatedLlmRequest</a>) -&gt; <a href=\"../error/type-result\">Result</a>&lt;<a href=\"../prompt_ir/struct-promptir\">PromptIR</a>&gt;"}} /></pre>
