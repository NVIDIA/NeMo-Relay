...
- [OpenAICachePlugin](/reference/api/rust-library-reference/nemo-relay-adaptive/acg/openai-plugin/struct-openaicacheplugin): OpenAI-specific provider plugin for deterministic JSON serialization.
