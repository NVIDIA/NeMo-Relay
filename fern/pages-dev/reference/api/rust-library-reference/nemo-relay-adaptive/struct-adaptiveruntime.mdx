...
<pre className="rust-signature"><code dangerouslySetInnerHTML={{"__html": "pub fn validate_config(config: &amp;<a href=\"config/struct-adaptiveconfig\">AdaptiveConfig</a>) -&gt; ConfigReport"}} /></pre>
...
<pre className="rust-signature"><code dangerouslySetInnerHTML={{"__html": "pub fn report(&amp;self) -&gt; &amp;ConfigReport"}} /></pre>
