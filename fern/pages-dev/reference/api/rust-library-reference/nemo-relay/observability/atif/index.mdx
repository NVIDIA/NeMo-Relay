...
This module provides types and an exporter that collects lifecycle events from the NeMo Relay runtime and converts them into ATIF trajectories conforming to the ATIF v1.6 schema.
...
- [AtifFinalMetrics](/reference/api/rust-library-reference/nemo-relay/observability/atif/struct-atiffinalmetrics): Aggregate statistics for the entire trajectory (ATIF v1.6 final_metrics).
