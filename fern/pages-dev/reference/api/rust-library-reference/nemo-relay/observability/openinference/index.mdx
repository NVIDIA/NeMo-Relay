...
- [OpenInferenceSubscriberOptions](/reference/api/rust-library-reference/nemo-relay/observability/openinference/struct-openinferencesubscriberoptions): Options for constructing an OpenInference subscriber from an existing tracer provider.
