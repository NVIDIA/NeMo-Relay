...
The event and its visible middleware/subscriber chains are snapshotted before this function returns. Sanitization and subscriber delivery happen later on the serial publication dispatcher.
