...
- [PendingMarkSpec](/reference/api/rust-library-reference/nemo-relay/api/event/struct-pendingmarkspec): Mark requested by middleware before its owning runtime scope exists.
