...
The current host negotiates ABI v5, then the frozen v4, v3, and legacy v2 tables.
...
[`nemo-relay-plugin` declarations](https://github.com/NVIDIA/NeMo-Relay/blob/0.9.0-rc.2/crates/plugin/src/lib.rs).
