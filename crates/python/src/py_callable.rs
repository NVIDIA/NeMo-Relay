                            ...
                            match iter.call_method0("__anext__") {
                                ...
                                Err(e) => {
                                    if e.is_instance_of::<pyo3::exceptions::PyStopAsyncIteration>(
                                        ...
                                        Err(FlowError::Internal(e.to_string()))
                                    }
                                }
                            }
                        });
                        ...
                        match coro_result {
                            ...
                            Ok(Some(coro)) => {
                                ...
                                let awaited: Result<Json, _> = match future_result {
                                    Ok(future) => match future.await {
                                        ...
                                        Err(e) => Python::attach(|py| {
                                            ...
                                            return Err(FlowError::Internal("__stop__".into()));
                                        }
                                            Err(FlowError::Internal(e.to_string()))
                                        }),
                                    },
                                ...
                                match awaited {
                                    ...
                                    Err(FlowError::Internal(ref msg)) if msg == "__stop__" => {
                                        break;
                                    }
                                    Err(e) => {
                                        let _ = tx.send(Err(e)).await;
                    ...
                    match coro_result {
                        ...
                        Ok(Some(coro)) => {
                            ...
                            match awaited {
                                ...
                                Err(FlowError::Internal(ref msg)) if msg == "__stop__" => break,
                                Err(e) => {
                                    let _ = tx.send(Err(e)).await;
                                    break;
                                }
    ...
    Arc::new(move |event: &Event| {
        Python::attach(|py| {
            let result = match event {
                Event::ScopeStart(inner) => py_fn.call1(
                    py,
                    (crate::py_types::PyScopeStartEvent {
                        inner: inner.clone(),
                    },),
                ),
                Event::ScopeEnd(inner) => py_fn.call1(
                    py,
                    (crate::py_types::PyScopeEndEvent {
                        inner: inner.clone(),
                    },),
                ),
                Event::ToolStart(inner) => py_fn.call1(
                    py,
                    (crate::py_types::PyToolStartEvent {
                        inner: inner.clone(),
                    },),
                ),
                Event::ToolEnd(inner) => py_fn.call1(
                    py,
                    (crate::py_types::PyToolEndEvent {
                        inner: inner.clone(),
                    },),
                ),
                Event::LLMStart(inner) => py_fn.call1(
                    py,
                    (crate::py_types::PyLLMStartEvent {
                        inner: inner.clone(),
                    },),
                ),
                Event::LLMEnd(inner) => py_fn.call1(
                    py,
