...
//! PyO3 native extension module for NVMagic.
//!
//! This crate compiles to a `_native` Python C extension that is imported by the
//! `nvmagic` Python package. It exposes all core runtime types and API functions
//! to Python via PyO3.
//!
//! ## Modules
//!
...
//! - `py_api` — Python-facing API functions (`nvmagic_push_scope`, etc.). Tool calls
