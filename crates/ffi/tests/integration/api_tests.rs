...
use nemo_relay_ffi::types::{
    ...
    FfiOpenTelemetrySubscriber, FfiPluginHostActivation, FfiScopeStack, FfiToolHandle,
...
unsafe fn validate_test_plugin_config(
...
unsafe fn activate_test_plugin_config(
    config_json: *const c_char,
    out_report_json: *mut *mut c_char,
) -> NemoRelayStatus {
...
unsafe fn test_plugin_host_report_json(out_report_json: *mut *mut c_char) -> NemoRelayStatus {
    if out_report_json.is_null() {
...
fn close_test_plugin_host() -> NemoRelayStatus {
