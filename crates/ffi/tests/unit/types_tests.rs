...
fn free_null_ffi_handles() {
    unsafe {
        ...
        nemo_relay_plugin_host_activation_free(std::ptr::null_mut());
    }
}
...
fn test_annotated_event_accessors_and_codec_handles() {
    ...
    let typesafe = api::nemo_relay_typesafe_system_one_codec_new();
    ...
    unsafe {
        ...
        nemo_relay_codec_free(typesafe);
