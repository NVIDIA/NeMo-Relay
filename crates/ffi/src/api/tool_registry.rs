...
use super::{
    NemoRelayFreeFn, NemoRelayStatus, NemoRelayToolConditionalCb,
    NemoRelayToolExecFrameInterceptCb, NemoRelayToolExecInterceptCb, NemoRelayToolSanitizeCb,
    c_char, c_str_to_string, clear_last_error, core_registry_api, status_from_error,
    wrap_tool_conditional_fn, wrap_tool_exec_frame_intercept_fn, wrap_tool_exec_intercept_fn,
...
/// `name` must be a valid C string. `cb` must be a valid function pointer.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn nemo_relay_register_tool_conditional_execution_guardrail(
    name: *const c_char,
    priority: i32,
...
/// `name` must be a valid C string.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn nemo_relay_deregister_tool_conditional_execution_guardrail(
    name: *const c_char,
) -> NemoRelayStatus {
    clear_last_error();
    let name = match c_str_to_string(name) {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn nemo_relay_register_tool_execution_intercept(
    name: *const c_char,
    priority: i32,
...
/// `name` must be a valid C string.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn nemo_relay_deregister_tool_execution_intercept(
    name: *const c_char,
) -> NemoRelayStatus {
    clear_last_error();
    let name = match c_str_to_string(name) {
