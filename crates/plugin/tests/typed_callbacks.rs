...
use nemo_relay_plugin::{
    ...
    NemoRelayNativeAsyncCompletion, NemoRelayNativeAsyncMiddlewareCb,
    ...
    NemoRelayNativeHostApiV3, NemoRelayNativeHostApiV3ToolFrames, NemoRelayNativeLlmCodecKind,
...
fn native_abi_v3_struct_sizes_are_self_describing() {
    ...
    #[cfg(target_pointer_width = "64")]
    {
        ...
        assert_eq!(
            ...
            440,
            "the frame registration hook must remain appended after the frozen ABI-v3 prefix"
        );
        assert_eq!(size_of::<NemoRelayNativeHostApiV3ToolFrames>(), 448);
        assert_eq!(
            host_api_offsets(),
            [
    ...
    #[cfg(target_pointer_width = "32")]
    {
        ...
        assert_eq!(size_of::<NemoRelayNativeHostApiV3ToolFrames>(), 220);
        assert_eq!(
            host_api_offsets(),
            [
...
unsafe extern "C" fn unavailable_async_stream_push_json(
...
unsafe extern "C" fn unavailable_async_stream_finish(
    _stream: *const NemoRelayNativeAsyncStream,
) -> NemoRelayStatus {
    NemoRelayStatus::InvalidArg
}

unsafe extern "C" fn unavailable_async_stream_reject(
    _stream: *const NemoRelayNativeAsyncStream,
    _message: *const NemoRelayNativeString,
) -> NemoRelayStatus {
    NemoRelayStatus::InvalidArg
...
unsafe extern "C" fn unavailable_async_stream_is_cancelled(
    _stream: *const NemoRelayNativeAsyncStream,
) -> bool {
    true
}

unsafe extern "C" fn unavailable_async_stream_release(_stream: *const NemoRelayNativeAsyncStream) {}

unsafe extern "C" fn unavailable_async_next_invoke_stream(
    _next: *const NemoRelayNativeAsyncNext,
    _invocation_json: *const NemoRelayNativeString,
    _stream: *const NemoRelayNativeAsyncStream,
...
#[allow(clippy::too_many_arguments)]
unsafe extern "C" fn unavailable_async_stream_middleware_registration(
    _ctx: *mut NemoRelayNativePluginContext,
    _name: *const NemoRelayNativeString,
    _priority: i32,
...
unsafe extern "C" fn unavailable_async_next_invoke_result(
    _next: *const NemoRelayNativeAsyncNext,
    _invocation_json: *const NemoRelayNativeString,
    _cb: NemoRelayNativeAsyncNextResultCb,
    _user_data: *mut c_void,
) -> NemoRelayStatus {
    NemoRelayStatus::InvalidArg
}
...
fn test_host_v3() -> NemoRelayNativeHostApiV3ToolFrames {
    ...
    NemoRelayNativeHostApiV3ToolFrames {
        v3: NemoRelayNativeHostApiV3 {
            ...
            async_stream_push_json: unavailable_async_stream_push_json,
            async_stream_finish: unavailable_async_stream_finish,
            async_stream_reject: unavailable_async_stream_reject,
            async_stream_is_cancelled: unavailable_async_stream_is_cancelled,
            async_stream_release: unavailable_async_stream_release,
            async_next_invoke_stream: unavailable_async_next_invoke_stream,
            plugin_context_register_async_stream_middleware:
                unavailable_async_stream_middleware_registration,
            async_next_invoke_result: unavailable_async_next_invoke_result,
        },
