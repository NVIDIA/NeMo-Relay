...
1. Define or reuse the callback type alias in
   `crates/core/src/context/callbacks.rs`.
...
2. Add the registry field to `NemoFlowContextState` in
   `crates/core/src/context/state.rs`.
...
- Type aliases: `crates/core/src/context/callbacks.rs`
- Context state: `crates/core/src/context/state.rs`
