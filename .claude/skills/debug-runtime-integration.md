...
---
description: Debug application-side NeMo Flow integration issues such as load failures, inactive scopes, missing events, or optimizer wiring problems
---
...
- Is the subscriber/exporter/runtime actually registered?
- Did the app choose the right public API layer: managed execute vs manual
  lifecycle vs typed wrappers vs optimizer runtime?
...
- optimizer runtime never registered or config validation ignored
