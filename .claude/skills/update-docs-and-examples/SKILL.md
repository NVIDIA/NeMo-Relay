...
- **Binding-specific usage changed**
  Update the matching getting-started doc under `docs/` and the binding README.
- **Observability changed**
  Update ATIF, OpenTelemetry, or OpenInference docs as applicable.
- **Adaptive or plugin-host behavior changed**
  Update `docs/adaptive-layer.md`, `docs/adaptive-api-reference.md`,
  `docs/hosted-plugins.md`, and any examples that rely on the old config shape.
