...
class PluginContext:
    ...
    """
    def register_export_activation_policy(self, callback: Callable[[object], object]) -> None: ...
    def register_export_target(self, registration: object, callback: Callable[[], object]) -> None: ...
