...
def stream_execute(
    ...
    *,
    ...
    Notes:
        ...
        the full response, not the final chunk. If the caller stops consuming
        early, call ``await stream.aclose()`` to cancel the producer and
        release native stream resources.
