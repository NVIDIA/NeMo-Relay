...
@dataclass(slots=True)
class BuiltinConfig:
    preset: Literal["trajectory_context"] | None = ...
    ...
    custom_mark_payload_policy: Literal["preserve", "redact_all_leaves"] | None = ...
    metric_string_attribute_allowlist: dict[str, list[str]] | None = ...
    def to_dict(self) -> JsonObject: ...
