...
class OpenTelemetrySessionFilterConfig:
    ...
    type: Literal["block_after_tool_match"] = ...
    session_metadata_key: str = ...
    unattributed_events: Literal["block_after_match"] = ...
    def to_dict(self) -> JsonObject: ...
...
class OpenTelemetryEndpointConfig:
    ...
    session_filter: OpenTelemetrySessionFilterConfig | None = ...
    def to_dict(self) -> JsonObject: ...
...
class OpenTelemetryLogSectionConfig:
    enabled: bool = ...
    endpoints: list[OpenTelemetrySignalEndpointConfig] | None = ...
    minimum_severity: Literal["trace", "debug", "info", "warn", "warning", "error"] = ...
    max_queue_size: int = ...
...
class OpenTelemetryMetricSectionConfig:
    ...
    temporality: Literal["cumulative", "delta", "low_memory"] = ...
    max_instruments: int = ...
...
class OpenTelemetrySectionConfig:
    ...
    logs: OpenTelemetryLogSectionConfig | None = ...
    metrics: OpenTelemetryMetricSectionConfig | None = ...
    def to_dict(self) -> JsonObject: ...
