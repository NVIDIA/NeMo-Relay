...
"""Tests for NeMo Agent Toolkit Nexus LLM Codec system.
...
class TestCodecsModuleImport:
    def test_codecs_module_import(self):
        ...
        from nat_nexus import AnnotatedLLMRequest as top_level_alr
        from nat_nexus._native import AnnotatedLLMRequest as native_alr
