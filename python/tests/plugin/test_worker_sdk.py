...
async def test_llm_sanitizers_receive_codec_context_and_can_omit_payloads():
    ...
    for codec_kind, codec_id in [
        ...
        (pb.LLM_CODEC_KIND_BUILTIN, "gemini"),
    ...
    assert seen == [
        ...
        ("request", LlmSanitizeRequestContext(plugin_api.LlmCodecIdentity("builtin", "gemini"))),
        ("response", LlmSanitizeResponseContext(plugin_api.LlmCodecIdentity("builtin", "gemini"))),
