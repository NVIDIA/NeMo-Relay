...
Example::
    ...
    nvmagic.guardrails.register_tool_sanitize_request("pii-filter", 10, redact_pii)
"""

from nvmagic._native import (
    nvmagic_deregister_llm_conditional_execution_guardrail as deregister_llm_conditional_execution,
)
from nvmagic._native import (
    nvmagic_deregister_llm_sanitize_request_guardrail as deregister_llm_sanitize_request,
)
from nvmagic._native import (
    nvmagic_deregister_llm_sanitize_response_guardrail as deregister_llm_sanitize_response,
)
from nvmagic._native import (
    nvmagic_deregister_tool_conditional_execution_guardrail as deregister_tool_conditional_execution,
)
from nvmagic._native import (
    nvmagic_deregister_tool_sanitize_request_guardrail as deregister_tool_sanitize_request,
)
from nvmagic._native import (
    nvmagic_deregister_tool_sanitize_response_guardrail as deregister_tool_sanitize_response,
)
from nvmagic._native import (
    nvmagic_register_llm_conditional_execution_guardrail as register_llm_conditional_execution,
)
from nvmagic._native import (
    # LLM guardrails
    nvmagic_register_llm_sanitize_request_guardrail as register_llm_sanitize_request,
)
from nvmagic._native import (
    nvmagic_register_llm_sanitize_response_guardrail as register_llm_sanitize_response,
)
from nvmagic._native import (
    nvmagic_register_tool_conditional_execution_guardrail as register_tool_conditional_execution,
)
from nvmagic._native import (
    # Tool guardrails
    nvmagic_register_tool_sanitize_request_guardrail as register_tool_sanitize_request,
)
from nvmagic._native import (
    nvmagic_register_tool_sanitize_response_guardrail as register_tool_sanitize_response,
)
