...
from nvmagic._native import (
    nvmagic_deregister_llm_execution_intercept as deregister_llm_execution,
)
from nvmagic._native import (
...
from nvmagic._native import (
    nvmagic_deregister_tool_request_intercept as deregister_tool_request,
)
from nvmagic._native import (
    nvmagic_deregister_tool_response_intercept as deregister_tool_response,
)
from nvmagic._native import (
    nvmagic_register_llm_execution_intercept as register_llm_execution,
)
from nvmagic._native import (
    # LLM intercepts
...
from nvmagic._native import (
    # Tool intercepts
    nvmagic_register_tool_request_intercept as register_tool_request,
)
from nvmagic._native import (
    nvmagic_register_tool_response_intercept as register_tool_response,
)
