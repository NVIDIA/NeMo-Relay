...
from nemo_flow.integrations.langgraph import instrument_graph
...
graph = instrument_graph(builder.compile())
...
For LangChain agents inside a LangGraph workflow, use `NemoFlowMiddleware` from this package the same way as the LangChain integration:
