...
Example:
    ```python
    from nat_nexus.optimizer import BackendSpec, OptimizerConfig, OptimizerRuntime, StateConfig
...
def validate_optimizer_config(config: OptimizerConfig | JsonObject) -> ConfigReport:
    ...
    Example:
        ```python
        from nat_nexus.optimizer import ComponentSpec, OptimizerConfig, validate_optimizer_config
